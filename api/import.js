...
(function(){
	...
	document.writeln("<script type='text/javascript'	src	= '"+APIURL+"application/core.js'></script>");

	// resource
	document.writeln("<script type='text/javascript'	src	= '"+APIURL+"plugins/resource.js'></script>");
	
	// zooming
	document.writeln("<script type='text/javascript'	src		= '"+APIURL+"plugins/zoomview/zoomview.js'></script>");
	document.writeln("<link type='text/css'						href	= '"+APIURL+"plugins/zoomview/zoomview.css' rel='stylesheet' />");
	...
	// main functions
	document.writeln("<script type='text/javascript'	src	= '"+APIURL+"application/functions.js'></script>");
})();
...
eBookSkin.objects = [
	...
	{ type:"window"		, id:"bottom_window"			, 'class':"mainobjects"	, visible:"pc", children:[
		{ type:"window"		, id:"bottom_center"			, 'class':"mainobjects"	, children:[
			{ type:"image" 		, id:"menu_twitter"			, 'class':"bottomobjects", src:"sns/twitter.svg"			, title:"Twitter"			, click:"eFnc.sendSNS('twitter')"},
			{ type:"image" 		, id:"menu_facebook"		, 'class':"bottomobjects", src:"sns/facebook.svg"			, title:"Facebook"		, click:"eFnc.sendSNS('facebook')"},

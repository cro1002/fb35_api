...
eBookSkin.objects = [
	...
	{ type:"window"		, id:"menu_window"				, 'class':"mainobjects", visible:"pc", children:[
		{ type:"window"		, id:"menu_center"			, 'class':"mainobjects"		, children:[
			...
			{ type:"image"		, id:"menu_draw_btn"			, 'class':"menuobjects", src:"menu/drawing.svg"		, title:"판서"			, click:"eFnc.runDrawing()"},
			...
			{ type:"image"		, id:"menu_thumb_btn"	, 'class':"menuobjects"		, src:"menu/thumbnail.svg"	, title:"섬네일 보기"	, click:"eFnc.wndToggle('#thumbnail_window')"	},
	...
	{ type:"window"		, id:"menu_window"				, 'class':"mainobjects", visible:"mobile", children:[
		...
		{ type:"window"		, id:"menu_center_m"			, 'class':"mainobjects"		, children:[
			...
			{ type:"image"		, id:"menu_thumb_btn_m"	, 'class':"menuobjects_m"		, src:"menu/thumblist.svg"	, title:"섬네일보기"	, click:"eFnc.wndToggle('#thumbnail_window')"	},

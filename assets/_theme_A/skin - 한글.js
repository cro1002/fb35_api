...
eBookSkin.objects = [
	...
	{ type:"window"		, id:"menu_window"				, 'class':"mainobjects", visible:"mobile", children:[
		...
		{ type:"window"		, id:"menu_center_m"			, 'class':"mainobjects"		, children:[
			...
			{ type:"image"		, id:"menu_draw_btn_m"			, 'class':"menuobjects_m", src:"menu/drawing.svg"			, title:"판서"			, click:"eFnc.runDrawing()"},
			{ type:"image"		, id:"menu_pdf_down_m"			, 'class':"menuobjects_m", src:"menu/pdf.svg"				, title:"PDF 내려받기"	, click:"eFnc.pdfDown()"},

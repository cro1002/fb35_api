...
eBookSkin.objects = [
	...
	{ type:"window"		, id:"menu_window"				, 'class':"mainobjects", visible:"pc", children:[
		{ type:"window"		, id:"menu_center"			, 'class':"mainobjects"		, children:[
			...
			{ type:"window"		, id:"search_window"				, 'class':"mainobjects", children:[
				...
				{ type:"image"		, id:"search_text_btn"		, 'class':"menuobjects", src:"search_pc.svg"		, title:"Search"			, click:"eFnc.searchByInput('#search_text')"		},
			]},
		]},
	]},
	...
	{ type:"window"		, id:"menu_window"				, 'class':"mainobjects", visible:"mobile", children:[
		...
		{ type:"window"		, id:"menu_center_m"			, 'class':"mainobjects"		, children:[
			{ type:"logo"			, id:"menu_logo_m"					, src:"logo.png"					, title:"Logo"	},
			{ type:"image"		, id:"menu_memo_btn_m"			, 'class':"menuobjects_m", src:"menu/memo.svg"			, title:"Memo"			, click:"eFnc.runMemo()"},
			{ type:"image"		, id:"menu_draw_btn_m"			, 'class':"menuobjects_m", src:"menu/drawing.svg"			, title:"Drawing"			, click:"eFnc.runDrawing()"},
			{ type:"image"		, id:"menu_pdf_down_m"			, 'class':"menuobjects_m", src:"menu/pdf.svg"				, title:"PDF Download"	, click:"eFnc.pdfDown()"},
			{ type:"image"		, id:"menu_tablelist_btn_m"	, 'class':"menuobjects_m", src:"menu/contents.svg"	, title:"Contents"			, click:"eFnc.wndToggle('#tablelist_window')"	},
			{ type:"image"		, id:"menu_slide_btn_m"			, 'class':"menuobjects_m", src:"menu/slide.svg"			, title:"Slide"	, click:"eFnc.runSlideShow()"},
			{ type:"image"		, id:"menu_bookmark_btn_m"	, 'class':"menuobjects_m", src:"menu/bookmark.svg"	, title:"Bookmark"		, click:"eFnc.wndToggle('#bookmarklist_window')"	},
			{ type:"image"		, id:"menu_thumb_btn_m"	, 'class':"menuobjects_m"		, src:"menu/thumbnail.svg"	, title:"Thumbnail"	, click:"eFnc.wndToggle('#thumbnail_window')"	},
			{ type:"image"		, id:"search_text_btn_m"	, 'class':"menuobjects_m", src:"menu/search.svg"		, title:"Search"			, click:"eFnc.searchByInput()"},
		]},
	]},
	...
	{ type:"window"		, id:"bottom_window"			, 'class':"mainobjects"	, visible:"pc"	, children:[
		...
		{ type:"home" 		, id:"sns_home"				, 'class':"snsobjects", src:"sns/home.svg"				, title:"Home"	},
	...
	{ type:"window"		, id:"bottom_window_m"			, 'class':"mainobjects"	, visible:"mobile"	, children:[
		{ type:"image"		, id:"quick_first_btn_m"	, 'class':"quickobjects_m", src:"quick/first.svg"	, title:"First Page"		, click:"eFnc.gotoPage(1)"	},
		{ type:"image"		, id:"quick_prev_btn_m"		, 'class':"quickobjects_m", src:"quick/prev.svg"		, title:"Previous Page"	, click:"eFnc.gotoPrev()"		},
		...
		{ type:"image"		, id:"quick_next_btn_m"		, 'class':"quickobjects_m", src:"quick/next.svg"		, title:"Next Page"	, click:"eFnc.gotoNext()"		},
		{ type:"image"		, id:"quick_last_btn_m"		, 'class':"quickobjects_m", src:"quick/last.svg"		, title:"Last Page"		, click:"eFnc.gotoPage(-1)"	},
	]},
	
	{ type:"image", id:"quick_menu_switch", 'class':"mainobjects", src:"link_menu.svg", title:"Link Menu", visible:"mobile", click:"eFnc.wndToggle('#links_window_m')"},
	...
	{ type:"window"		, id:"links_window_m", 'class':"mainobjects", visible:"mobile"	, children:[
		...
		{ type:"home" 		, id:"sns_home"				, 'class':"snsobjects_m", src:"sns/home.svg"				, title:"Home"	},
	...
	{ type:"tablelist"		, id:"tablelist_window"			,	draggable:true, resizable:true	},	// Contents창
	{ type:"bookmarklist"	, id:"bookmarklist_window"	,	draggable:true, resizable:true	},	// 책갈피창
	{ type:"searchlist"		, id:"searchlist_window"		,	draggable:true, resizable:true	},	// Search창

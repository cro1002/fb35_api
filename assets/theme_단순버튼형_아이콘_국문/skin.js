...
eBookSkin.objects = [
		...
		{ type:"window"		, id:"top_center"				, 'class':"mainobjects", children:[
			...
			{ type:"window"		, id:"menu_window"			, 'class':"mainobjects"		, children:[
				...
				{ type:"window"		, id:"menu_contents"			, 'class':"mainobjects"		, children:[
					...
					{ type:"image"		, id:"menu_draw_btn"			, 'class':"menuobjects", src:"menu/drawing.svg"		, title:"판서"			, click:"eFnc.runDrawing()&eFnc.wndHide('#menu_window')" },
					...
					{ type:"image"		, id:"menu_thumb_btn"			, 'class':"menuobjects", src:"menu/thumbnail.svg"	, title:"섬네일보기"	, click:"eFnc.wndToggle('#thumbnail_window')"	},
				]},
			]},
	...
	{ type:"window"		, id:"bottom_window"			, 'class':"mainobjects text_right"	, visible:"pc", children:[
		...
		{ type:"image" 		, id:"menu_twitter"			, 'class':"quickobjects sns_pos", src:"sns/twitter.svg"			, title:"트위터"			, click:"eFnc.sendSNS('twitter')"},
		{ type:"image" 		, id:"menu_facebook"		, 'class':"quickobjects sns_pos", src:"sns/facebook.svg"			, title:"페이스북"		, click:"eFnc.sendSNS('facebook')"},
	...
	{ type:"window"		, id:"bottom_window"			, 'class':"mainobjects text_left"	, visible:"mobile", children:[
		...
		{ type:"image" 		, id:"menu_twitter"			, 'class':"quickobjects_m sns_pos_m", src:"sns/twitter.svg"			, title:"트위터"			, click:"eFnc.sendSNS('twitter')"},
		{ type:"image" 		, id:"menu_facebook"		, 'class':"quickobjects_m sns_pos_m", src:"sns/facebook.svg"			, title:"페이스북"		, click:"eFnc.sendSNS('facebook')"},
		{ type:"image" 		, id:"menu_kakaotalk"		, 'class':"quickobjects_m sns_pos_m", src:"sns/kakaotalk.svg"		, title:"카카오톡"		, click:"eFnc.sendSNS('kakaotalk')" },
